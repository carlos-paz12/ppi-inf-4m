            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="carros_update.php?id=<?=$carro->id?>" class="btn material-symbols-outlined" id="btn-editar">edit</a>
                        </td>
                        <td>
                            <a href="database/services/delete_service.php?id=<?=$carro->id?>" class="btn material-symbols-outlined" id="btn-deletar">delete</a>
                        </td>
                    </tr>
                <?php
                endforeach;
